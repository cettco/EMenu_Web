            ...
            <div class="main-container-inner">
                ...
                <div class="main-content">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <form enctype="multipart/form-data" class="form-horizontal" id="shoptype-form" action="/orderonline/index.php/RestaurantManage/AddSeat" method="post">
                                    ...
                                    <?php
                                        ...
                                        {
                                            $tableno = $tablearr->result()[$i]->table_no;
                                            if($tableno > $no)
                                            {
                                                $no = $tableno;
                                            }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="col-sm-1" size="10" value="<?php echo $newtableno;?>" name="tableno" id="ShopType_tag" type="text" />

                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-1"><label for="ShopType_name">二维码数据</label></label>
                                        <input class="col-sm-5" size="50" value="<?php echo $restaurantid."-".$newtableno?>" name="qrcodedata" id="description" type="text" />
