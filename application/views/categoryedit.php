            ...
            <div class="main-container-inner">
                ...
                <div class="main-content">
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            <li><a href="/orderonline/public/shoptype/index.html">菜单</a></li>
                            ...
                            <div class="col-sm-10">
                                <form enctype="multipart/form-data" class="form-horizontal" id="shoptype-form" action="/orderonline/index.php/RestaurantManage/EditMenuType?accountid=<?php echo $accountid;?>" method="post">
                                    ...
                                    <?php
                                        ...
                                        $categoryarr = $this->Management_Model->select_row($categoryid,'category');
                                        $categoryname = $categoryarr->result()[0]->name;
                                        $description = $categoryarr->result()[0]->description;
                                    ?>
                                    <div class="form-group">
                                        <label class="col-sm-1"><label for="ShopType_tag">菜品类id</label></label>
                                        <input class="col-sm-1" size="10" value="<?php echo $categoryid;?>" readonly name="categoryid" id="categoryid" type="text" />

                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1"><label for="ShopType_tag">菜品类名</label></label>
                                        <input class="col-sm-1" size="10" value="<?php echo $categoryname;?>" name="name" id="ShopType_tag" type="text" />

                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-1"><label for="ShopType_name">菜品描述</label></label>
                                        <input class="col-sm-5" size="50" value="<?php echo $description;?>" name="description" id="description" type="text" />
                                    </div>
