            ...
            <div class="main-container-inner">
                ...
                <div class="main-content">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <form enctype="multipart/form-data" class="form-horizontal" id="shoptype-form" action="/orderonline/index.php/RestaurantManage/AddMenuItem?accountid=<?php echo $accountid;?>" method="post">
                                    ...
                                    <div id="basicinfo" class="tab-pane active">
                                        <div class="form-group">
                                            ...
                                            <input class="col-sm-4" name="itemname" id="itemname" type="text" />
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-1">
                                            ...
                                            <textarea class="col-sm-3" rows="5" name="description" id="description">
                                            </textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="col-sm-2" name="unit" id="unit">
                                                ...
                                                <option value="杯" selected="selected">
                                                            杯
                                                </option>
                                                <option value="瓶" selected="selected">
                                                            瓶
                                                </option>
                                                <option value="碗" selected="selected">
                                                            碗
                                                </option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="col-sm-2" name="price" id="price" type="text" />
                                        </div>
                                    </div>
